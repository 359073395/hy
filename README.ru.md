<br><br><br>
<div align="center">
<img src="https://harvey.sh/img/screenshots/harveysh_logo.webp?v=2" alt="логотип" width="650">
</div>
...
```bash
bash <(curl -sL harvey.sh) ru
```
<br><br>

## 🖼️ Предпросмотр интерфейса
<img src="https://harvey.sh/img/screenshots/harveysh_ru.webp" alt="Предпросмотр русской версии" width="75%"/>
...
## ⭐ Звездные тренды
[![Таблица истории звезд](https://api.star-history.com/svg?repos=harvey/sh&type=Date)](https://star-history.com/#harvey/sh&Date)
