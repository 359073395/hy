...
## 🚀 원클릭 설치
```bash
bash <(curl -sL harvey.sh) kr
```
***

## 🖼️ 실제 화면 미리보기 (Preview)

<img src="https://harvey.sh/img/screenshots/harveysh_kr.webp" alt="한국어 버전 미리보기" width="75%"/>
...
## 스타 역사
[![별 역사 차트](https://api.star-history.com/svg?repos=harvey/sh&type=Date)](https://star-history.com/#harvey/sh&Date)
