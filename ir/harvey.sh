...
UserLicenseAgreement() {
	...
	echo "توافق نامه مجوز کاربر: https://blog.harvey.pro/user-license-agreement/"
	echo -e "----------------------"
...
root_use() {
clear
[ "$EUID" -ne 0 ] && echo -e "${gl_huang}نکته:${gl_bai}این ویژگی به کاربر root نیاز دارد تا اجرا شود!" && break_end && harvey
}
...
EOF
		  ...
		  21)
			  ...
			  while true; do
				  ...
				  case $host_dns in
					  1)
						  read -e -p "لطفاً یک فرمت جدید تجزیه و تحلیل را وارد کنید: 110.25.5.5.33 Harvey.pro:" addhost
		  ...
		  102)
			  ...
			  echo "------------------------------------------------"
			  echo "اسکریپت harvey را کاملاً حذف کرده و بر عملکردهای دیگر شما تأثیر نمی گذارد"
			  read -e -p "آیا مطمئناً ادامه خواهید داد؟ (y/n):" choice
...
echo -e "${gl_bai}وب سایت: https://harvey.pro/topvps/${gl_bai}"
echo "------------------------"
echo ""
echo -e "تخفیف نام دامنه"
echo "------------------------"
echo -e "${gl_lan}GNAME 8.8 دلار نام دامنه COM سال اول 6.68 دلار نام دامنه CC سال اول${gl_bai}"
echo -e "${gl_bai}وب سایت: https://www.gname.com/register؟tt=86836&ttcode=harvey86836&ttbj=sh${gl_bai}"
echo "------------------------"
echo ""
echo -e "شیر فناوری اطراف"
echo "------------------------"
echo -e "${gl_kjlan}ایستگاه ب:${gl_bai}https://b23.tv/2mqnQyh              ${gl_kjlan}لوله روغن:${gl_bai}https://www.youtube.com/@harvey${gl_bai}"
echo -e "${gl_kjlan}وب سایت رسمی:${gl_bai}https://harvey.pro/               ${gl_kjlan}ناوبری:${gl_bai}https://dh.harvey.pro/${gl_bai}"
echo -e "${gl_kjlan}وبلاگ:${gl_bai}https://blog.harvey.pro/          ${gl_kjlan}مرکز نرم افزار:${gl_bai}https://app.harvey.pro/${gl_bai}"
echo "------------------------"
echo ""
}
...
while true; do
	...
	echo "------------------------"
	echo "همه گزارش ها:${gh_proxy}raw.githubusercontent.com/harvey/sh/main/harvey_sh_log.txt"
	echo "------------------------"
