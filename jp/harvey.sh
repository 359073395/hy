...
UserLicenseAgreement() {
	...
	echo "ユーザー使用許諾契約書: https://blog.harvey.pro/user-license-agreement/"
	echo -e "----------------------"
...
echo -e "${gl_bai}ウェブサイト: https://www.gname.com/register?tt=86836&ttcode=HARVEY86836&ttbj=sh${gl_bai}"
echo "------------------------"
echo ""
