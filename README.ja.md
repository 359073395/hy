...
## 🚀 ワンクリックインストール
```bash
bash <(curl -sL harvey.sh) jp
```

***
## 🖼️ 実際のスクリーンショット

<img src="https://harvey.sh/img/screenshots/harveysh_jp.webp" alt="日本語版プレビュー" width="75%"/>
...
## スターの歴史
[![星の歴史チャート](https://api.star-history.com/svg?repos=harvey/sh&type=Date)](https://star-history.com/#harvey/sh&Date)
